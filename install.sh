pacman -S base-devel xorg xorg-server xorg-xinit xf86-video-vesa fish alacritty curl git sudo ttf-dejavu wqy-microhei firefox python python-pip neofetch ctags ranger habak thunderbird fcitx fcitx-configtool fcitx-im fcitx-googlepinyin gimp kdenlive blender audacity jdk11-openjdk libreoffice-fresh tree net-tools
